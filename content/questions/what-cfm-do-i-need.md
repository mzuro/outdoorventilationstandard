...
Start from the minimum, size to the recommended tier for the exposure class you actually have, and adjust for BTU and mount type before shopping for a blower. A CFM rating alone, without a hood face area and mounting height behind it, is not a specification — it's a guess.
