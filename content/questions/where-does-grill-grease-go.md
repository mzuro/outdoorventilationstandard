...
Deposition is not a fixed tax on grilling — it tracks the hood's capture fraction directly. A hood achieving 95% capture holds the 2-meter deposition rate to about 3-10 mg/m² per hour, cosmetically negligible; the same site at 50% capture sees 100-250 mg/m² per hour, visible staining after one session (RB-011 §4.1). Under the most common failure conditions — inadequate overhang or a 5-8 mph crosswind — 25 to 40% of the aerosol escapes, roughly 75 to 120 grams of grease spread over adjacent surfaces per season (RB-011 §3.2). The levers that raise capture are the usual ones: [width and overhang](/questions/what-size-hood-for-my-grill/), [CFM](/questions/what-cfm-do-i-need/), and [wind mitigation](/questions/do-side-panels-work/).
...
The dominant outdoor grease-fire scenario is not spontaneous ignition — it is a flare-up or ember reaching a surface that has quietly accumulated grease (RB-011 §3.6.1). An ignitable film (5-20 g/m²) forms on the deck directly below the grill within 1 to 2 seasons if never cleaned, which is why RB-011 recommends cleaning the deck within half a meter of the grill after every session and out to 2 meters monthly during the season (RB-011 §3.6.4). Inside the hood the concentration is highest of all: the plume impingement pattern loads the hood's center 2 to 3 times faster than its edges (RB-012 §4.4), each 2-hour session adds about 7 grams to the filters, and manufacturer guidance to clean or replace them every 1 to 3 months is consistent with that loading rate (RB-011 §3.9). Filter and tray cleaning is fire prevention, not housekeeping (RB-011 §4.5).
